...
class User {
    constructor(id, userName, salary){
        ...
        this.msg1 = function(){                                     // [this] refers to object i created from this function
            return `Hello ${userName} your salary is ${this.s}`;    // [this.s] to get bonus if found
        };
    };
...
userOne = new User(22, "Ahmed", 5000);
